# 🦡 Honey Badger OS User Guide# 🦡 Honey Badger OS - Complete User Guide# Honey Badger OS - Complete User Guide

## Fearless Multi-Distribution Post-Install Scripts**Transform any Linux distribution into a fearless development powerhouse!**Welcome to **Honey Badger OS** - a custom Linux distribution built from scratch with complete honey badger theming, multi-architecture support, and professional-grade features

Welcome to Honey Badger OS! Like the honey badger, our scripts are fearless, determined, and uncompromising in transforming your Linux system into a powerful development environment.Welcome to **Honey Badger OS** - a comprehensive collection of post-install scripts that transforms your existing Linux distribution into a fully-featured, themed development environment. Like the honey badger itself, these scripts are determined, fearless, and uncompromising.## 📋 Table of Contents

## Quick Start## 📋 Table of Contents1. [Getting Started](#-getting-started)

### One-Command Installation2. [System Requirements](#-system-requirements)

```bash1. [What is Honey Badger OS?](#-what-is-honey-badger-os)3. [Available Editions](#-available-editions)
...
### Supported Distributions3. [Supported Distributions](#-supported-distributions)5. [First Boot & Setup](#-first-boot--setup)



| Distribution Family | Distributions | Package Manager |4. [Installation Types](#-installation-types)6. [Using Honey Badger OS](#-using-honey-badger-os)

|---|---|---|

| **Arch** | Arch Linux, Manjaro, EndeavourOS, ArcoLinux | pacman + yay |5. [Quick Start Guide](#-quick-start-guide)7. [Advanced Features](#-advanced-features)

| **Debian** | Debian, Ubuntu, Mint, Pop!_OS, Elementary | apt |

| **Red Hat** | Fedora, RHEL, CentOS, AlmaLinux, Rocky | dnf/yum |6. [Detailed Installation Guide](#-detailed-installation-guide)8. [Development & Building](#-development--building)

| **Slackware** | Slackware, Salix | slackpkg |

| **Void** | Void Linux | xbps |7. [After Installation](#-after-installation)9. [Troubleshooting](#-troubleshooting)



### Installation Types8. [Using Honey Badger OS](#-using-honey-badger-os)10. [Contributing](#-contributing)



1. **Full** - Complete desktop environment with development tools9. [Customization](#-customization)

2. **Developer** - Programming tools with basic desktop

3. **Desktop** - XFCE desktop with productivity apps10. [Troubleshooting](#-troubleshooting)---
...
- **XFCE4** with complete application suite---**Honey Badger OS** is a Debian-based Linux distribution featuring:

- **Custom Honey Badger theme** (brown/gold colors)

- **LightDM** display manager## 🌟 What is Honey Badger OS?- **Complete visual theming** with honey badger branding
...
- **nano** as default with syntax highlighting**Honey Badger OS** is NOT a traditional Linux distribution. Instead, it's a sophisticated collection of post-installation scripts that **transforms your existing Linux installation** into a powerful, themed development environment.- **Nano editor integration** as the default system editor

- **Custom key bindings** (Ctrl+S save, Ctrl+Q quit)

- **Line numbers and mouse support**- **Professional build system** for custom distributions
...
- **Languages**: Python, Node.js, Go, Rust, C/C++, Java🦡 **Fearless Multi-Distribution Support** - Works with Arch, Debian, Ubuntu, Fedora, Slackware, Void Linux, and more### Quick Start

- **Tools**: Git, Docker/Podman, VS Code

- **Databases**: PostgreSQL, MySQL, SQLite clients💪 **Determined Setup Process** - Comprehensive installation that handles dependencies, configurations, and optimizations automatically1. Download the appropriate ISO from the `/ISOs/` directory



### 📦 Applications2. Write to USB drive or boot in virtual machine

- **Office**: LibreOffice suite

- **Graphics**: GIMP, Inkscape🎯 **Uncompromising Features** - Full development stack, custom theming, enhanced editor configuration, and productivity applications3. Experience the honey badger themed Linux environment

- **Media**: VLC, Audacity

- **Browsers**: Firefox, Chromium4. Explore nano editor with custom honey badger colors



## Post-Installation Commands🚀 **Ready for Anything** - Complete development environment configured in one script execution
...
honey-badger-update      # Update all packages## 💻 System Requirements

honey-badger-install pkg # Install packages

```- **Enhanced nano Editor**: Fully configured with syntax highlighting, custom key bindings, and Honey Badger theme



## Troubleshooting- **Custom Visual Theme**: Brown and gold color scheme throughout the desktop environment### Minimum Requirements



### Common Issues- **Complete Development Stack**: Python, Node.js, Go, Rust, C/C++, Java, Ruby, PHP, and more



**"Distribution not supported"**- **XFCE Desktop Environment**: Full desktop with productivity applications (optional)- **RAM**: 2GB minimum, 4GB recommended

- Check if your distro is based on a supported family

- Try running the family script directly from `distros/`- **Utility Scripts**: Custom management tools for your Honey Badger system- **Storage**: 8GB available space



**"Permission denied"**- **Architecture**: ARM64 (AArch64) or x86_64

```bash

chmod +x install.sh---- **Boot**: UEFI or Legacy BIOS support
...
- Update package databases first### Minimum Requirements- **ARM64**: Raspberry Pi 4, Apple Silicon Macs, ARM64 servers

- Check internet connection

- View logs in `/tmp/honeybadger-install.log`- **x86_64**: Intel/AMD processors, most modern PCs

### Getting Help| Component | Minimum | Recommended |- **Virtual Machines**: QEMU, VirtualBox, VMware, etc

1. Check installation logs for specific errors|-----------|---------|-------------|

2. Search issues on GitHub

3. Open new issue with system info and error details| **RAM** | 2GB | 4GB+ |### Recommended Specs

## Advanced Usage| **Storage** | 1GB free (minimal) | 5GB+ free (full) |

### Environment Variables| **Architecture** | x86_64 or aarch64 | x86_64 or aarch64 |- **RAM**: 4GB+ for optimal performance

Set installation type without prompts:| **Internet** | Required | Broadband recommended |- **Storage**: 16GB+ for full installation

```bash| **Privileges** | sudo access | sudo access |- **Network**: Ethernet or Wi-Fi for updates

export HONEY_BADGER_INSTALL_TYPE="developer"

./install.sh- **Display**: 1024x768 minimum resolution

```

### Supported Architectures

Available types: `full`, `developer`, `desktop`, `minimal`
...
- **nano**: Edit `~/.nanorc`- **aarch64** (ARM 64-bit) - Full support including Raspberry Pi 4, Apple Silicon Macs## 📦 Available Editions

- **Theme**: Modify `~/.themes/HoneyBadger/`

- **XFCE**: Use `xfce4-settings-manager`### Installation Time & Size### ARM64 (AArch64) - Production Ready

## System Requirements| Installation Type | Time | Size | Description |#### Basic Edition (`honey-badger-os-basic-20251101.iso`) - 347MB

- **Supported Linux distribution**|------------------|------|------|-------------|

- **Internet connection**

- **Sudo privileges**| **Minimal** | 10-20 min | ~500MB-1GB | Command-line tools only |- **Purpose**: Minimal, functional ARM64 system

- **Minimum 1GB free disk space**

- **Recommended 3-5GB for full installation**| **Developer** | 20-40 min | ~2-3GB | Development focused |- **Includes**: Essential tools, nano editor, SSH server

---| **Desktop** | 20-40 min | ~2-3GB | Desktop productivity |- **Branding**: Basic honey badger identity

## 🦡 Like the honey badger, be fearless in your development!| **Full** | 30-60 min | ~3-5GB | Complete workstation |- **Use Case**: Servers, embedded systems, minimal installs

**"Honey badger don't care, honey badger don't give a shit!"** - And neither should you about complex Linux setup. Let Honey Badger OS handle the configuration while you focus on being awesome.---#### Themed Edition (`honey-badger-os-themed-20251101.iso`) - 348MB ⭐ **RECOMMENDED**

Happy coding! 🦡## 🐧 Supported Distributions- **Purpose**: Full honey badger experience
