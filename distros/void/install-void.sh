...
LOG_FILE="/tmp/honeybadger-void-install.log"
...
show_banner() {
    ...
    echo "  🦡 ================================================== 🦡" | tee -a "$LOG_FILE"
    echo "     HONEY BADGER OS - VOID LINUX INSTALLER" | tee -a "$LOG_FILE"
    echo "     Fearless Void Linux Distribution Setup" | tee -a "$LOG_FILE"
    echo "  🦡 ================================================== 🦡" | tee -a "$LOG_FILE"
